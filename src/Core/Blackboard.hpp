...
protected:
    ...
    // ROSModule
    std::vector<s_ROSModuleMessage> ROSModuleMessageList;                           /*!< ROSModule Messages Buffer */
    std::mutex                      mutex_ROSModuleMessageList;                     /*!< Mutex from ROSModuleMessageList */
...
public:
    ...
    std::condition_variable         conditional_ROSModuleMessageList;               /*!< Conditional variable. Releases Module for reading messages*/
    ...
    */
    ...
    // ROSModule Messages
    bool                            isROSModuleMessageListEmpty();                              /*!< \brief A function that returns the status of the ROSModuleMessageList Buffer.
                                                                                                 *  \return true if the buffer is empty, false otherwise.
                                                                                                 */
    void                            addROSModuleMessage(s_ROSModuleMessage& vROSModuleMessage); /*!< \brief A method responsible for adding a ROSModuleMessage to the ROSModuleMessageList Buffer.
                                                                                                 *  \param vROSModuleMessage a s_ROSModuleMessage that will be added to the ROSModuleMessageList.
                                                                                                 */
    void                            getROSModuleMessage(s_ROSModuleMessage& vROSModuleMessage); /*!< \brief A method responsible for getting one ROSModuleMessage of the ROSModuleMessageList Buffer.
                                                                                                 *  \param vROSModuleMessage a s_ROSModuleMessage where the values will be written on.
                                                                                                 */
